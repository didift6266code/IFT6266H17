...
if __name__ == '__main__':
    ...
    numpy_rng = np.random
    MOD_OPTM = MODEL_OPTIMIZER(batch_size, epsilon_dis, epsilon_dis,num_filters_g=[16,32,64,128],\
                num_filters_d=[8,16,32,64,128,128,128,128,1], sim_dict_lgth = sim_dict_lgth, X_words_lgth=62)#35631
    ...
    discriminator_update, generator_update,  get_valid_cost  = MOD_OPTM.optimize_gan(train_chunk, val_chunk,\
                                                                  train_caption_chunk,val_caption_chunk, lam1=0.001)
    ...
    for epoch in range(epochs+1):
        ...
        if epoch >=0:
            ...
            for chunk_val_j in range(num_chunk_val):
                val_chunk.set_value(val_data[chunk_val_j*chunk_size:(chunk_val_j+1)*chunk_size], borrow=True)
    ...
    for i in range(15) :
        ...
        misc.imsave("/home2/ift6ed45/AA_GAN_PRJ_CODE/MODELS_PRJ/images"+str(i)+".png",gen_images_best[i])
        misc.imsave("/home2/ift6ed45/AA_GAN_PRJ_CODE/MODELS_PRJ/images_orig"+str(i)+".png", Orig_images_best[i])
